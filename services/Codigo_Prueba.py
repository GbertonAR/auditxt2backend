...
def transcribe():
    ...
    configuration.api_key["Ocp-Apim-Subscription-Key"] = "{YOUR_SUBCRIPTION_KEY}"
    configuration.host = f"https://gbert-mc4ywhok-eastus2.cognitiveservices.azure.com/speechtotext/v3.2"
...
#PC=https://gbert-mc4ywhok-eastus2.cognitiveservices.azure.com/
#COD=85GOJDUSDxaoYdndEVBXUicds34AxjlFFsYd6HTdcQzuQGkgxIjIJQQJ99BFACHYHv6XJ3w3AAAAACOGxk5H
#Reg=eastus2
